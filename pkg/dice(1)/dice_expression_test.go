...
func TestDiceExpression_Comprehensive(t *testing.T) {
	tests := []struct {
		...
		// Concat тесты (61-82)
		// {"concat simple", "d66", false},
		// {"concat with zero", "d408", false},
		// {"concat long", "d123456789", false},
		// {"concat single zero", "d0", false},
		// {"concat single digit", "d9", false},
		// {"concat one modifier", "d66cm1:5", false},
		// {"concat two modifiers", "d66cm1:5cm2:-3", false},
		// {"concat three modifiers", "d999cm1:1cm2:2cm3:3", false},
		// {"concat complex modifiers", "d505cm1:-6cm3:150", false},
		// {"concat modifier with plus", "d66cm1:+5", false},
		// {"concat zero modifier", "d123cm2:0", false},
		// {"concat empty error", "d", true},
		// {"concat incomplete modifier error", "d66cm", true},
		// {"concat modifier no value error", "d66cm1:", true},
		// {"concat modifier no dice error", "d66cm:5", true},
		// {"concat duplicate modifier error", "d66cm1:5cm1:3", true},
		// {"concat zero dice index error", "d66cm0:5", true},
		// {"concat dice index out of range error", "d66cm4:5", true},
		// {"concat negative dice index error", "d66cm-1:5", true},
		// {"concat invalid modifier value error", "d66cm1:abc", true},
		// {"concat invalid dice index error", "d66cmabc:5", true},
		// {"concat unknown token error", "d66unknown", true},
		// {"dl6 token error", "dl6", true},

		// // Смешанные тесты (83-90)
		// {"d6 as concat", "d6", false},
		// {"only dice count error", "2d", true},
		// {"only d error", "d", true},
		// {"empty string error", "", true},
		// {"only spaces error", "   ", true},
		// {"uppercase D", "2D6", false},
	}
